...
function unpackMeta(input) {
  return packrup.unpackToArray(input, {
    key({ key }) {
...
function generateTagsStrict(input) {
  const parsed = zod.headSchema.parse(input);
...
const tagToString = (tag) => {
  ...
  let attrs = packrup.unpackToString(tag.props, {
    entrySeparator: " ",
    keyValueSeparator: "=",
    wrapValue: '"',
    resolve({ key, value }) {
...
exports.generateHtmlStrict = generateHtmlStrict;
exports.generateTags = generateTags;
exports.generateTagsStrict = generateTagsStrict;
exports.packMeta = packMeta;
exports.renderTemplate = renderTemplate;
exports.resolveSeoHead = resolveSeoHead;
