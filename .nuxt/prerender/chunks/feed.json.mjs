import { defineEventHandler, appendHeader } from 'file:///Users/bon/Documents/my-workspace/nuxt-blog/node_modules/.pnpm/h3@0.7.21/node_modules/h3/dist/index.mjs';
import { g as generateBlogFeed } from './rss.mjs';
import 'file:///Users/bon/Documents/my-workspace/nuxt-blog/node_modules/.pnpm/feed@4.2.2/node_modules/feed/lib/feed.js';
...
const feed_json = defineEventHandler(async (event) => {
  const feed = await generateBlogFeed(event);
  appendHeader(event, "Content-Type", "application/json");
  return feed.json1();
});

export { feed_json as default };
//# sourceMappingURL=feed.json.mjs.map
