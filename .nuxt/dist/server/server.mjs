import { getCurrentInstance, reactive, ref, onServerPrefetch, unref, toRef, isRef, inject, defineComponent, computed, h, resolveComponent, watch as watch$1, watchEffect, defineAsyncComponent, getCurrentScope, onScopeDispose, markRaw, provide, Suspense, Transition, shallowRef, onErrorCaptured, useSSRContext, nextTick, mergeProps, withCtx, createVNode, toDisplayString, openBlock, createElementBlock, createElementVNode, createStaticVNode, createBlock, Fragment as Fragment$1, withAsyncContext, createCommentVNode, createTextVNode, createApp } from "vue";
import { $fetch as $fetch$1 } from "ohmyfetch";
import { joinURL, hasProtocol, parseURL, withBase, withLeadingSlash, withoutTrailingSlash, isEqual as isEqual$1, encodePath, encodeParam } from "ufo";
...
import { unpackMeta as unpackMeta$1, packMeta } from "zhead";
import { ssrRenderSuspense, ssrRenderComponent, ssrInterpolate, ssrRenderAttrs, ssrRenderList, ssrRenderClass } from "vue/server-renderer";
import { createSchemaOrg } from "@vueuse/schema-org";
import { articleResolver, breadcrumbResolver, personResolver, webPageResolver, webSiteResolver } from "schema-org-graph-js";
...
const main = "";
const components = {
  Breadcrumbs: defineAsyncComponent(() => import("./_nuxt/Breadcrumbs.1630eadf.js").then((c) => c.default || c)),
  CodeBlock: defineAsyncComponent(() => import("./_nuxt/CodeBlock.62d22384.js").then((c) => c.default || c)),
  Image: defineAsyncComponent(() => import("./_nuxt/Image.544dd2b2.js").then((c) => c.default || c)),
  List: defineAsyncComponent(() => import("./_nuxt/List.00d821bb.js").then((c) => c.default || c)),
  PostList: defineAsyncComponent(() => import("./_nuxt/PostList.cb0f3f6a.js").then((c) => c.default || c)),
  ProjectList: defineAsyncComponent(() => import("./_nuxt/ProjectList.c03362a5.js").then((c) => c.default || c)),
  Prose: defineAsyncComponent(() => import("./_nuxt/Prose.3b01a91f.js").then((c) => c.default || c)),
  Tip: defineAsyncComponent(() => import("./_nuxt/Tip.2fd789f0.js").then((c) => c.default || c)),
  WindiIcon: defineAsyncComponent(() => import("./_nuxt/WindiIcon.c96381a8.js").then((c) => c.default || c)),
  ContentDoc: defineAsyncComponent(() => import("./_nuxt/ContentDoc.275f24fb.js").then((c) => c.default || c)),
  ContentList: defineAsyncComponent(() => import("./_nuxt/ContentList.40628fce.js").then((c) => c.default || c)),
  ContentNavigation: defineAsyncComponent(() => import("./_nuxt/ContentNavigation.c52a1fd2.js").then((c) => c.default || c)),
  ContentQuery: defineAsyncComponent(() => import("./_nuxt/ContentQuery.0bfd106b.js").then((c) => c.default || c)),
  ContentRenderer: defineAsyncComponent(() => import("./_nuxt/ContentRenderer.db5b5b9b.js").then((c) => c.default || c)),
  Markdown: defineAsyncComponent(() => import("./_nuxt/Markdown.9a5e26d7.js").then((c) => c.default || c)),
  MarkdownRenderer: defineAsyncComponent(() => import("./_nuxt/MarkdownRenderer.5d536282.js").then((c) => c.default || c)),
  ProseA: defineAsyncComponent(() => import("./_nuxt/ProseA.2c798e88.js").then((c) => c.default || c)),
  ProseBlockquote: defineAsyncComponent(() => import("./_nuxt/ProseBlockquote.7bffc1c5.js").then((c) => c.default || c)),
  ProseCode: defineAsyncComponent(() => import("./_nuxt/ProseCode.a8b25332.js").then((c) => c.default || c)),
  ProseCodeInline: defineAsyncComponent(() => import("./_nuxt/ProseCodeInline.11fab5cd.js").then((c) => c.default || c)),
  ProseEm: defineAsyncComponent(() => import("./_nuxt/ProseEm.3c1afd96.js").then((c) => c.default || c)),
  ProseH1: defineAsyncComponent(() => import("./_nuxt/ProseH1.f46c294e.js").then((c) => c.default || c)),
  ProseH2: defineAsyncComponent(() => import("./_nuxt/ProseH2.eb428fec.js").then((c) => c.default || c)),
  ProseH3: defineAsyncComponent(() => import("./_nuxt/ProseH3.2dd85124.js").then((c) => c.default || c)),
  ProseH4: defineAsyncComponent(() => import("./_nuxt/ProseH4.b129df17.js").then((c) => c.default || c)),
  ProseH5: defineAsyncComponent(() => import("./_nuxt/ProseH5.481336f9.js").then((c) => c.default || c)),
  ProseH6: defineAsyncComponent(() => import("./_nuxt/ProseH6.1535acfc.js").then((c) => c.default || c)),
  ProseHr: defineAsyncComponent(() => import("./_nuxt/ProseHr.207d6d4e.js").then((c) => c.default || c)),
  ProseImg: defineAsyncComponent(() => import("./_nuxt/ProseImg.610bae40.js").then((c) => c.default || c)),
  ProseLi: defineAsyncComponent(() => import("./_nuxt/ProseLi.2935d876.js").then((c) => c.default || c)),
  ProseOl: defineAsyncComponent(() => import("./_nuxt/ProseOl.ce21eb5c.js").then((c) => c.default || c)),
  ProseP: defineAsyncComponent(() => import("./_nuxt/ProseP.4fde5aca.js").then((c) => c.default || c)),
  ProseStrong: defineAsyncComponent(() => import("./_nuxt/ProseStrong.a15b8263.js").then((c) => c.default || c)),
  ProseTable: defineAsyncComponent(() => import("./_nuxt/ProseTable.548dec36.js").then((c) => c.default || c)),
  ProseTbody: defineAsyncComponent(() => import("./_nuxt/ProseTbody.a8bbc247.js").then((c) => c.default || c)),
  ProseTd: defineAsyncComponent(() => import("./_nuxt/ProseTd.10a9ea00.js").then((c) => c.default || c)),
  ProseTh: defineAsyncComponent(() => import("./_nuxt/ProseTh.80491611.js").then((c) => c.default || c)),
  ProseThead: defineAsyncComponent(() => import("./_nuxt/ProseThead.7c262cec.js").then((c) => c.default || c)),
  ProseTr: defineAsyncComponent(() => import("./_nuxt/ProseTr.a53793e4.js").then((c) => c.default || c)),
  ProseUl: defineAsyncComponent(() => import("./_nuxt/ProseUl.0e75691a.js").then((c) => c.default || c))
};
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/_...slug_.6047544b.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.b7a96c6e.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const SocialIcons_vue_vue_type_style_index_0_scoped_e5313bd6_lang = "";
...
export {
  ...
  throwError as B,
  useContentHead as C,
  SchemaOrgWebPage as D,
  useMetaTags as E,
  SchemaOrgArticle as F,
  SchemaOrgBreadcrumb as S,
  __nuxt_component_0$3 as _,
  useRoutesContent as a,
  _export_sfc as b,
