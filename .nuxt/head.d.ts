// Generated by path discovery
export type PublicFiles = '/apple-touch-icon.png'|'/cover.png'|'/favicon-16x16.png'|'/favicon-32x32.png'|'/favicon.ico'|'/logo.webp'|'/robots.txt'
